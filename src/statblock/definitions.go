...
var (
	...
	FeatTumble                 Feat            = Feat{"tumble", "Tumble", []FeatBuff{{DEX, "1", []string{}}}, []Ability{}, "This creature gains a +1 bonus to its DEX and can Juke with one will point if it has the skill", []string{}, "https://wiki.cavesofqud.com/images/6/62/Tumble_skill.png"}
